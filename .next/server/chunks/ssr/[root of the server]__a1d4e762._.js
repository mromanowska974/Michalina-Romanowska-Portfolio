...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ addProject(formData) {
    const project = {
        ...
        repoLink: formData.get('repo-link')
    };
    if (isInvalidText(project.name) || isInvalidText(project.technologies) || isInvalidText(project.description) || isInvalidText(project.appLink) || isInvalidText(project.repoLink)) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$api$2d$utils$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["redirect"])('/projects');
}
;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a1d4e762._.js.map