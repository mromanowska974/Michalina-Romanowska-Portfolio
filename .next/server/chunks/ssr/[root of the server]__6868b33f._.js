...
function getQuestion(id) {
    db.prepare(`SELECT * FROM questions WHERE id = ?`).run(id);
}
}}),
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ addQuestion(formData) {
    ...
    const question = {
        ...
        answer: await __TURBOPACK__imported__module__$5b$externals$5d2f$bcrypt__$5b$external$5d$__$28$bcrypt$2c$__cjs$29$__["default"].hash(unhashedAnswer, 2)
    };
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6868b33f._.js.map